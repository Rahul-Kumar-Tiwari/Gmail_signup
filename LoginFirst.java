...
{ 
    ...
    public void actionPerformed(ActionEvent e1)
    {
		if(e1.getSource()==b1)
			...
			String val2="select signup_username,signup_password,signup_name,signup_photo from signup where signup_username='"+name+"'";			
			...
			while(rs.next())
			{
				...
				ph1=rs.getString("signup_photo");
				
			}
			if(name.equals(username))
			{
				new PasswordDemo(password,name,n2,ph1);
				f1.setVisible(false);
			}
			else
			{
